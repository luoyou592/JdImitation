...
public class SexGirlPagerDialog extends Dialog {
    ...
    public SexGirlPagerDialog(Context context) {
        this(context, 0);
    }

    public SexGirlPagerDialog(Context context, int themeResId) {
    ...
    private void init() {
        ...
        mBtnImageViewPager.setVisibility(View.GONE);
        setContentView(view);
        //radiobutton的初始化
