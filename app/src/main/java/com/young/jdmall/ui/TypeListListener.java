 ...
 */
public class TypeListListener extends RecyclerView.OnScrollListener {

    private static final String TAG = TypeListListener.class.getSimpleName();
    ...
    public TypeListListener(View target) {
        if (target == null) {
