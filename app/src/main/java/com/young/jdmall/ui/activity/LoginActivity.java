...
//					conn.setDoInput(true);
    ...
    public void loginBy(final String name, String password){
        ...
        Observable<LoginInfoBean> loginObservable = RetrofitFactory.getInstance().listLogin(name, password);
        loginObservable.compose(compose(this.<LoginInfoBean>bindToLifecycle())).subscribe(new BaseObserver<LoginInfoBean>(this) {
            @Override
            protected void onHandleSuccess(LoginInfoBean loginInfoBean) {
                Log.d("luoyou", "loginInfo"+loginInfoBean.getUserInfo());
                Log.d("luoyou", "loginerror"+loginInfoBean.getError());
                if (loginInfoBean.getUserInfo()!=null){
                    Toast.makeText(LoginActivity.this,"登录成功",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
                    Toast.makeText(LoginActivity.this,loginInfoBean.getError(),Toast.LENGTH_SHORT).show();
                }
            }
