...
public class CancelOdFragment extends BaseFragment {
    ...
    private static final String TAG = "CancelOdFragment";

    private void initData() {

        Call<OrderInfoBean> call = (Call<OrderInfoBean>) RetrofitFactory.getInstance().listOrderInfo(PreferenceUtils.getUserId(getActivity()), 3, page, 10);
...
//                    Toast.makeText(getActivity(), "获取3订单", Toast.LENGTH_SHORT).show();
