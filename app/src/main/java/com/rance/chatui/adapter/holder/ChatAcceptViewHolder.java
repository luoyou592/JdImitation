...
//        Glide.with(getContext()).load(data.getHeader()).bitmapTransform(new CropCircleTransformation(chatItemHeader.getContext())).into(chatItemHeader);
        chatItemHeader.setBackgroundResource(R.drawable.wn);
