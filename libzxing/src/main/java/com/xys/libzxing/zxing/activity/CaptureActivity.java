    ...
    public void onCreate(Bundle icicle) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resultIntent.putExtra("GoodsId", "1");
...
//        CaptureActivity.this.finish();
        ...
        if (text.indexOf("超级牛逼团队开发") != -1) {
            Gson gson = new Gson();
            final HashMap<String, String> map = gson.fromJson(text, new TypeToken<HashMap<String, String>>() {
            }.getType());
            Log.d(TAG, "handleDecode: " + map);
            ...
            title.setText("发现商品：" + map.get("goods"));
            ...
            confirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    alertDialog.dismiss();
                    Intent resultIntent = new Intent();
                    resultIntent.putExtra("GoodsId", map.get("id"));
